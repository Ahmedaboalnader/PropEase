  ...
  return (
    ...
    >
      <Group className="!px-4 sm:px-6 md:px-0 !w-full sm:!max-w-[80%] md:!max-w-[45%]">
        <Group className="!md:mb-3 !w-full">
          <Text className="!text-xl sm:!text-2xl md:!text-3xl !font-bold !mb-2 sm:!mb-8 md:!mb-10 text-center sm:text-left">
            Login your Account
          </Text>
        </Group>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-2 w-full">
          <div className="flex mb-4 w-full">
            <button
              type="button" 
              className={`flex-1 text-center py-2 text-sm sm:text-base border-b-2 ${
                activeTab === 'email'
                  ? 'border-black font-semibold'
                  : 'border-transparent text-gray-500'
              }`}
